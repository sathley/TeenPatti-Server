...
//    {
//        public static CompareResult Compare(this Hand handA, Hand handB, Variation variation, Dictionary<string,string> additionalInfo)
//        {

//            return CompareEngine.Compare(variation, handA, handB, additionalInfo);
